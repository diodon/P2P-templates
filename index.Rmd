...
- Save the [The DataSheet_longformat_TEST](protocols/DataSheet_longformat_TEST.xlsx) file in the "Data" folder. This is the data table that you will substitute with your own data.

Now, just copy the code chunks below and paste them into your R console.

# Basic Setup

You need a few packages to run this code. Check that the "Data", IPT" and "Analysis" folders are created under your working directory. [The DataSheet_longformat_TEST](protocols/DataSheet_longformat_TEST.xlsx) file should be available in the "Data" folder.
