---
title: "DwCA_gen"
author: "Eduardo Klein and Enrique Montes"
date: "10/7/2020"
output:
  html_document:
    number_sections: yes
...
This code transforms long format data tables of the Marine Biodiversity Observation Network Pole to Pole of the Americas ([MBON Pole to Pole](https://marinebon.org/p2p/)) into Darwin Core Archive files for data sharing through the Ocean Biodiversity Information System ([OBIS](https://obis.org/)). It also generates anintegrated file ready for analysis. Just copy the code chunks below and paste into your R console.
